...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		FeishuConnectClientID:                                  settings.FeishuConnectClientID,
		FeishuConnectClientSecretConfigured:                    settings.FeishuConnectClientSecretConfigured,
		FeishuConnectRedirectURL:                               settings.FeishuConnectRedirectURL,
		FeishuConnectRequireEmail:                              settings.FeishuConnectRequireEmail,
