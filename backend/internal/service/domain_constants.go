...
// FeishuConnectSyntheticEmailDomain 是飞书（Lark）Connect 用户的合成邮箱后缀（RFC 保留域名）。
...
const (
	...
	// Feishu (Lark) Connect OAuth 登录设置
	...
	SettingKeyFeishuConnectRequireEmail = "feishu_connect_require_email"
