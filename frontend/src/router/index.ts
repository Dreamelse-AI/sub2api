...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/auth/feishu/email-completion',
    name: 'feishu-email-completion',
    component: () => import('@/views/auth/FeishuEmailCompletionView.vue'),
    meta: {
      requiresAuth: false,
      title: 'Feishu Email Completion'
    }
  },
  {
